...
- **Shared (Git) in multi-root workspaces** — prompt for the target workspace folder before creating, importing, opening, or promoting shared memories instead of always writing into the first workspace folder.
