...
[![Beta 0.3.5](https://img.shields.io/badge/beta-0.3.5-orange)](CHANGELOG.md)
...
**Nemo beta 0.3.5** manages Copilot native memories plus team-shared Git context and a read-only view of project markdown you can attach to chat without moving files.
...
In multi-root workspaces, Nemo now asks which workspace folder should receive **Shared (Git)** writes before creating or importing shared memories.
...
Install via **Extensions: Install from VSIX…** (`nemo-context-0.3.5.vsix`).
